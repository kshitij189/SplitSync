  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = isLogin
        ...
        : { username, password, email, firstName, lastName, inviteCode };
      ...
      <div className="auth-card">
        ...
        <div className="oauth-section">
          ...
          >
            ...
            <span>{googleLoading ? 'Signing in...' : (isLogin ? 'Continue with Google' : 'Sign up with Google')}</span>
          </button>
        </div>
        ...
        <div className="auth-toggle">
          ...
          <button type="button" onClick={() => { setIsLogin(!isLogin); setError(''); }} className="toggle-button">
